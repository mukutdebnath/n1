...
from models import resnet as resnetmodel
...
parser.add_argument('--arch', '-a', metavar='ARCH', default='resnet20',
                    ...
                    ' (default: resnet32)')
parser.add_argument('--adc', help='adc model: ss, cco, ideal', default='ideal')
parser.add_argument('--adcbits', help='number of adc bits', default=7, type=int)
parser.add_argument('--adcdata', help='adc model: ss, cco, ideal', default='ss')
...
def main():
    ...
    if (args.arch=='resnet20_adc'):
        ...
        adc_range=(2**(7-5)-1/2**5)*1
        adc_char, zero_off = adcdata.__dict__['noadc'](7, 0, adc_range)
        model = torch.nn.DataParallel(resnetmodel.__dict__[args.arch](adc_char, zero_off, 5, 1))
