...
from models import resnet20_q as resnet
...
parser.add_argument('--savemodel', '-sm', default='resnet20_baseline_original.pt')
...
def main():
    ...
    model = torch.nn.DataParallel(resnet.net(num_classes=10, a_bit=args.a_bit, af_bit=args.af_bit, w_bit=args.w_bit, wf_bit=args.wf_bit))
    print('Dict',resnet.net(num_classes=10, a_bit=args.a_bit, af_bit=args.af_bit, w_bit=args.w_bit, wf_bit=args.wf_bit))
    model.cuda()
    model_save_name = args.savemodel
